...
<body>
    <div class="header">
        Baliwag Transit Bus Booking
    </div>
    <div class="container">
        <!-- Tab Navigation -->
        <div class="tabs">
            <button id="tabSelectBus" class="active" onclick="showSection('selectBus', 'tabSelectBus')">Select
                Bus</button>
            <button id="tabPassengerInfo" onclick="showSection('passengerInfo', 'tabPassengerInfo')">Passenger
                Information</button>
            <button id="tabPayment" onclick="showSection('payment', 'tabPayment')">Payment</button>
            <button id="tabReceipt" onclick="showSection('receipt', 'tabReceipt')">Receipt</button>
        </div>

        <!-- Select Bussssssssssssssssssssssssssssss SECTION -->
        <div id="selectBus" class="section active">
            <h3 style="margin-bottom: 5px;">Route:</h3>
            ...
            <div id="busDiv">
                ...
                <div id="busPic">
                    ...
                    <img id="busImg" src="../images/baliwag_frontView.png" alt="Bus Picture">
                </div>

                <!-- example lang Golden Bee Bus -->
                <div id="busPic">
                    <strong>Golden Bee 9030</strong>
                    <img id="busImg" src="../images/gb_frontView.png" alt="Bus Picture">
                </div>
            </div>
            ...
            <div id="lalagyanBtn">
                <button id="pinakaBtn" type="button" onclick="showSection('passengerInfo', 'tabPassengerInfo')">
                    Next
                </button>
            </div>
        </div>
        ...
        <div id="passengerInfo" class="section">
            <form method="POST" onsubmit="event.preventDefault();">
                ...
                <div id="lalagyanBtn">
                    ...
                    <button id="pinakaBtn" type="button" onclick="showSection('payment', 'tabPayment')">
                        Next
                    </button>
                </div>
            </form>
        ...
        <div id="payment" class="section">
            ...
            <!-- Next Button -->
            <div id="lalagyanBtn">
                <button id="pinakaBtn" type="button" onclick="showSection('receipt', 'tabReceipt')">
                    Next
                </button>
            </div>
        </div>
